    ...
    return (
        <>
            <footer className="fadeInUp col-md-12">
                <a href="https://github.com/otienodominic/kemunto" className="button github"><svg xmlns="http://www.w3.org/2000/svg"
            ...
            <h5 className="text-center copyright"> © Copyrights reserved by Dominic Ngalo</h5>
        </>
    )
}
