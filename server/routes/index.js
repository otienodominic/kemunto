...
router.post('/api/posts/userprofiletodb', (req, res, next) => {
  const values = [req.body.username, req.body.email, req.body.password,req.body.email_verified]
  pool.query(`INSERT INTO users(username, email, email_verified, password,date_created)
              VALUES($1, $2, $3, $4, NOW())
